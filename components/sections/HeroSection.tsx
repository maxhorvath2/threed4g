...
export function HeroSection() {
	...
	return (
		<section ref={sectionRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
			...
			<div
				ref={orb1Ref}
				className="absolute top-1/4 left-1/4 w-[500px] h-[500px] rounded-full bg-[#22c55e]/10 blur-[120px] pointer-events-none"
			/>
			<div
				ref={orb2Ref}
				className="absolute bottom-1/4 right-1/4 w-[600px] h-[600px] rounded-full bg-[#22c55e]/5 blur-[150px] pointer-events-none"
			/>
			<div
				ref={orb3Ref}
				className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] rounded-full bg-[#16a34a]/10 blur-[100px] pointer-events-none"
			/>
